...
export type SymbolType = "stock" | "etf" | "crypto" | "forex" | "index" | "derivative" | "bond" | "options" | "futures" | "economy";
export const SUPPORTED_TYPES: SymbolType[] = ["stock", "etf", "crypto", "forex", "index", "derivative", "bond", "options", "futures", "economy"];
