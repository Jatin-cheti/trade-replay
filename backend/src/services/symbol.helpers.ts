...
export type SymbolType = "stock" | "etf" | "crypto" | "forex" | "index" | "derivative" | "bond" | "options" | "futures";
export const SUPPORTED_TYPES: SymbolType[] = ["stock", "etf", "crypto", "forex", "index", "derivative", "bond", "options", "futures"];
