...
export const env = {
  ...
  ASSET_SERVICE_URL: CONFIG.ASSET_SERVICE_URL,
  ASSET_SERVICE_INTERNAL_PORT: CONFIG.ASSET_SERVICE_INTERNAL_PORT,
  ASSET_SERVICE_INTERNAL_TOKEN: CONFIG.ASSET_SERVICE_INTERNAL_TOKEN,
