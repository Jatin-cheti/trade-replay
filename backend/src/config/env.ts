...
export const env = {
  ...
  REDIS_URL_QUEUE: CONFIG.redisQueueUrl,
  REDIS_URL_PUBSUB: CONFIG.redisPubsubUrl,
  REDIS_URL_FALLBACK: CONFIG.redisFallbackUrl,
  ...
  ASSET_SERVICE_URL: CONFIG.assetServiceUrl,
  ASSET_SERVICE_INTERNAL_PORT: CONFIG.assetServiceInternalPort,
  ASSET_SERVICE_INTERNAL_TOKEN: CONFIG.assetServiceInternalToken,
