...
const symbolSchema = new Schema(
  {
    ...
    mappingAttempts: { type: Number, default: 0 },
    allSourcesTried: { type: Boolean, default: false },
    needsManualReview: { type: Boolean, default: false },
    mappingConfidence: { type: String, enum: ["high", "medium", "low"], default: "low" },
    domainUsed: { type: String, trim: true, default: "" },
    lastMappedAt: { type: Date },
    logoStatus: { type: String, enum: ["pending", "mapped", "failed"], default: "pending" },
    logoLastUpdated: { type: Date },
    validated: { type: Boolean, default: false },
    styleValidated: { type: Boolean, default: false },
