/* eslint-disable react-refresh/only-export-components -- useSidebar hook is co-exported with components in a single multi-line export block; shadcn canonical API */
