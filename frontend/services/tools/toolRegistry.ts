...
export const toolDefinitions: ToolDefinition[] = [
  ...
  /* ── Lines → CHANNELS ───────────────────────────────────────── */
  // TV-parity: parallel channel uses 3 anchors (baseline start, baseline end, parallel-rail position) drawn via wizard click flow.
  def({ id: 'channel', label: 'Parallel channel', category: 'lines', subSection: 'Channels', family: 'line', iconKey: 'Layers', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: lineSchema }),
  ...
  /* ── Lines → PITCHFORKS ─────────────────────────────────────── */
  def({ id: 'pitchfork', label: 'Pitchfork', category: 'lines', subSection: 'Pitchforks', family: 'line', iconKey: 'GitFork', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: lineSchema }),
  def({ id: 'schiffPitchfork', label: 'Schiff pitchfork', category: 'lines', subSection: 'Pitchforks', family: 'line', iconKey: 'GitFork', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: lineSchema }),
  def({ id: 'modifiedSchiffPitchfork', label: 'Modified Schiff pitchfork', category: 'lines', subSection: 'Pitchforks', family: 'line', iconKey: 'GitFork', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: lineSchema }),
  def({ id: 'insidePitchfork', label: 'Inside pitchfork', category: 'lines', subSection: 'Pitchforks', family: 'line', iconKey: 'GitFork', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: false, supportsFill: true, supportsLevels: false }, optionsSchema: lineSchema }),

  /* ── Fibonacci ──────────────────────────────────────────────── */
  // TradingView default fib retracement levels include the extension targets (1.618, 2.618, 3.618, 4.236).
  def({ id: 'fibRetracement', label: 'Fib retracement', category: 'fib', subSection: 'Fibonacci', family: 'fib', iconKey: 'Waves', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: true, supportsFill: false, supportsLevels: true }, optionsSchema: fibSchema, behaviors: { fibLevels: [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1, 1.618, 2.618, 3.618, 4.236] } }),
  def({ id: 'fibExtension', label: 'Trend-based fib extension', category: 'fib', subSection: 'Fibonacci', family: 'fib', iconKey: 'Waves', capabilities: { anchors: 2, draggable: true, resizable: true, supportsText: true, supportsFill: false, supportsLevels: true }, optionsSchema: fibSchema, behaviors: { fibLevels: [0, 0.382, 0.5, 0.618, 1, 1.272, 1.414, 1.618, 2, 2.618, 3.618, 4.236] } }),
