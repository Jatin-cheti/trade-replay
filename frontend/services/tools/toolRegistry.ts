...
export const toolDefinitions: ToolDefinition[] = [
  ...
  def({ id: 'fibExtension', label: 'Trend-based fib extension', category: 'fib', subSection: 'Fibonacci', family: 'fib', iconKey: 'Waves', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: true, supportsFill: false, supportsLevels: true }, optionsSchema: fibSchema, behaviors: { fibLevels: [0, 0.236, 0.382, 0.5, 0.618, 0.786, 1, 1.618, 2.618] } }),
  ...
  def({ id: 'fibTrendTime', label: 'Trend-based fib time', category: 'fib', subSection: 'Fibonacci', family: 'fib', iconKey: 'Clock3', capabilities: { anchors: 3, draggable: true, resizable: true, supportsText: true, supportsFill: false, supportsLevels: true }, optionsSchema: fibSchema }),
